...
public class Kasiyer extends Thread {
    ...
    public void run() {
        while (!musteriler.isEmpty()){
            ...
            if(musteri != null){
                System.out.println("Müşteri : " + musteri + " lütfen kasiyer -> " + kasiyerNo);
                ...
                System.out.println("Kasiyer -" + kasiyerNo + " müşteri -" + musteri + " işlem süresi : " + sure);
                try {
        ...
        if(!islemYapilanMusteriler.isEmpty()){
